...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    branch: Schema.Attribute.Enumeration<['Argentina & Uruguay', 'Brasil']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
...
export interface ApiMateriaMovementMateriaMovement
  extends Struct.CollectionTypeSchema {
...
export interface ApiMaterialMaterial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    material_movements: Schema.Attribute.Relation<
      'oneToMany',
      'api::materia-movement.materia-movement'
    >;
    name: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiToolTool extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warrantyExpirationDate: Schema.Attribute.Date;
  };
}
...
export interface ApiVolunteerVolunteer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    users: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    volunteerBethelId: Schema.Attribute.Text;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::materia-movement.materia-movement': ApiMateriaMovementMateriaMovement;
